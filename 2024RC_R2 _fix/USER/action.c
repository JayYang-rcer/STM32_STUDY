...
void Update_Action_gl_position(float value[6])
{
	...
	//变换到底盘中心
	// ROBOT_CHASSI.POSITION.POSITION_X =  ACTION_GL_POS_DATA.REAL_X-161.86f * sin(ROBOT_CHASSI.Angle* PI / 180) ;
	// ROBOT_CHASSI.POSITION.POSITION_Y =  ACTION_GL_POS_DATA.REAL_Y+161.86f * cos(ROBOT_CHASSI.Angle* PI / 180) ; 
}
